...
```
 It is important to start with the top right corner, than the bottom right, then bottom left, than end by top left corner !
...
```
You can set the inputs in the python file .
